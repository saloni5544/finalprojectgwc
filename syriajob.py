...
if  strawberry == "find a job":
    ...
    if blueberry=="farming/manual labor"
        print("You get sick from a lack of pay and resources like food and water, so you have to go to the hospital and die because the hospital doesn't treat you due to corruption. Syria was too rough for you. GAME OVER!!)
#EWD GAME
